	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('ziyuanfenlei', this.id);
		...
		methods: {
			...
			onPayTap(){
				...
				uni.setStorageSync('paytable','ziyuanfenlei');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				...
				uni.setStorageSync('crossTable','ziyuanfenlei');
			...
			async init(){
				...
				let res = await this.$api.info('ziyuanfenlei', this.id);
				this.detail = res.data;
