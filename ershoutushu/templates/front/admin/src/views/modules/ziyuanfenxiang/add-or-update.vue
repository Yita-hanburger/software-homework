<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="资源编号" prop="ziyuanbianhao">
					<el-input v-model="ruleForm.ziyuanbianhao" placeholder="资源编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.ziyuanbianhao" label="资源编号" prop="ziyuanbianhao">
					<el-input v-model="ruleForm.ziyuanbianhao" placeholder="资源编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info'&& !ro.ziyuanwendang" label="资源文档" prop="ziyuanwendang">
					<file-upload
						tip="点击上传资源文档"
						action="file/upload"
						:limit="1"
						:multiple="true"
						:fileUrls="ruleForm.ziyuanwendang?ruleForm.ziyuanwendang:''"
						@change="ziyuanwendangUploadChange"
					></file-upload>
				</el-form-item>  
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.ziyuanwendang" label="资源文档" prop="ziyuanwendang">
					<el-button :style='{"border":"2px solid #c8c8c8","cursor":"pointer","padding":"0 20px","margin":"0 20px 0 0","color":"inherit","textAlign":"left","minWidth":"350px","outline":"none","borderRadius":"0px","background":"none","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.ziyuanwendang)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="!ruleForm.ziyuanwendang" label="资源文档" prop="ziyuanwendang">
					<el-button :style='{"border":"2px solid #c8c8c8","cursor":"pointer","padding":"0 20px","margin":"0 20px 0 0","color":"inherit","textAlign":"left","minWidth":"350px","outline":"none","borderRadius":"0px","background":"none","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small">无</el-button>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.ziyuanxiangqing" label="资源详情" prop="ziyuanxiangqing">
                    <span :style='{"border":"2px solid #c8c8c8","padding":"0 20px","color":"inherit","background":"none","display":"inline-block","width":"auto","fontSize":"14px","lineHeight":"40px","minWidth":"350px","fontWeight":"500"}' v-html="ruleForm.ziyuanxiangqing"></span>
                </el-form-item>
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.ziyuanxiangqing = this.ruleForm.ziyuanxiangqing.replace(reg,'../../../ershoutushu/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
	...
	if(this.ruleForm.ziyuanwendang!=null) {
		this.ruleForm.ziyuanwendang = this.ruleForm.ziyuanwendang.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
    ...
    ziyuanwendangUploadChange(fileUrls) {
	    this.ruleForm.ziyuanwendang = fileUrls;
    },
  }
};
</script>
